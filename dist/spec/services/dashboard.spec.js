...
var dashboard_1 = require("../../src/services/dashboard");
describe('Dashboard Model', function () {
    ...
    it('topFiveSellers return top 5 sellers DESC in terms of quantity', function () { return __awaiter(void 0, void 0, void 0, function () {
        var store, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    store = new dashboard_1.DashboardQueries();
                    return [4 /*yield*/, store.topFiveSellers()];
                case 1:
                    result = _a.sent();
